...
print('train matrix shape, after loading: ',eval_image_mat.shape);
...
x_train = np.zeros(shape=(train_image_range,image_dim,image_dim,3), dtype='uint8')
...
np.save('D:/PrivacyPreservingDistributedDL/Filters/x_train_size_512.npy',x_train)
np.save('D:/PrivacyPreservingDistributedDL/Filters/y_train_size_512.npy',y_train)   
...
for i in tqdm(range(0,validation_set_size-1)):
    ...
    #plt.show()
    #time.sleep(2);
np.save('D:/PrivacyPreservingDistributedDL/Filters/x_vali.npy',x_eval)
np.save('D:/PrivacyPreservingDistributedDL/Filters/y_vali.npy',y_eval)
...
for i in tqdm(range(0,39706-1)):
    ...
    #plt.show()
    #time.sleep(2);
np.save('D:/PrivacyPreservingDistributedDL/Filters/x_TestSub_2.npy',x_Test)
